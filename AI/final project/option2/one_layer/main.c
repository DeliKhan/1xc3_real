...
int main()
{
    ...
    double W3[num_outputs][num_neurons_layer2];
    double b3[num_outputs][1];
    ...
    double a3[num_outputs][num_train];
    ...
    for (int ep = 0; ep < epochs; ep++)
    {
        ForwardPass(num_train, X_train,
                    W2, W3,
                    b2, b3,
                    a2, a3); // forward pass goes through the entire sample to get output for all sample
        // the backward pass will compare this to the answers to see the amount of error
