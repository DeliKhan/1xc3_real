...
int main()
{
    ...
    // This is an unknown character if you convert this to a character (by using placeholder %c)
    //  ------------------------- short --------------------------
    ...
    printf(" char used saving integer BUT the character is printed: %u\n", Ped_NumChar);
    printf(" char used saving integer : %d\n", Ped_NumChar);
    printf(" unsigned char saving integer : %c\n", Ped_NumChar_unsigned); // use %u to get number
    printf(" short : %hd\n", Ped_sh);
